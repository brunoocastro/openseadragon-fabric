...
class FabricOverlay {
    ...
    resizeFabric() {
        ...
        this._fabricCanvas.absolutePan(new fabric_1.Point(canvasOffset.left - x + pageScroll.x, canvasOffset.top - y + pageScroll.y));
    }
    ...
    constructor(viewer, { fabricCanvasOptions = { selection: false } }, id) {
        ...
        this.resizeCanvas();
        this._fabricCanvas = new fabric_1.Canvas(this._canvas, fabricCanvasOptions);
