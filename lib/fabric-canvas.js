...
class FabricOverlay {
    ...
    constructor(viewer, { staticCanvas, fabricCanvasOptions }) {
        let self = this;
        this._viewer = viewer;
        ...
        this._id = "osd-overlaycanvas-" + (0, crypto_1.randomUUID)();
        this._canvas.setAttribute("id", this._id);
        this._canvasDiv.appendChild(this._canvas);
        this.resize();
        if (staticCanvas) {
            this._fabricCanvas = new fabric_1.fabric.StaticCanvas(this._canvas, fabricCanvasOptions);
        }
        else {
